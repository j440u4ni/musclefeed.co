...
const initialState = (categories && typeof categories === 'string' && categories !== "undefined") && (weights && typeof weights === 'string' && weights !== "undefined") && (perfumes && typeof perfumes === 'string' && perfumes !== "undefined") ? 
{ categories: cookie.get('product-categories'), weights: cookie.get('product-weights'), perfumes: cookie.get('product-perfumes') } : { categories: null, weights: null, perfumes: null };
