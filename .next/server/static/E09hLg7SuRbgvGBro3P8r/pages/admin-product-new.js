  ...
  component_add_category_createClass(SAddProductCategory, [{
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_antd_["Drawer"], {
        ...
        }, "S\xE9l\xE9ctionnez Parent"),
        className: "category-select-input",
        onChange: this.onParent
      }, this.state.categories && Array.isArray(this.state.categories) ? external_react_default.a.createElement(external_antd_["Select"].Option, {
        value: 0,
        className: "category-select-input"
      }, external_react_default.a.createElement("span", {
        className: "cart-select-option"
      }, "Aucun Parent")) && this.state.categories.map(function (item) {
        if (item.parent === 0) {
        ...
        className: "category-select-option"
      }, "Aucune Cat\xE9gorie")))), external_react_default.a.createElement("div", {
        className: "col-12 p-0"
      }, external_react_default.a.createElement("div", {
        className: "d-flex flex-row justify-content-space-between m-0 mt-2"
      }, external_react_default.a.createElement("div", {
...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function onSelectCategory(keys, event) {
      this.setState({
    ...
    value: function render() {
      ...
      }, "Cat\xE9gories"), external_react_default.a.createElement(external_antd_["Tree"], {
        multiple: false,
      ...
      }) : this.state.categories && Array.isArray(this.state.categories) && this.state.categories.filter(function (item) {
        return item.parent === 0;
      }).map(function (item) {
        return external_react_default.a.createElement(TreeNode, {
          className: "category-tree-admin",
          title: external_react_default.a.createElement("span", {
            className: "category-tree-admin-name"
          }, item.name),
          key: "".concat(item.id)
