...
function (_Component) {
  ...
  function SAdminProductNew(props) {
    ...
    _this.onProductKeyCommand = _this.onProductKeyCommand.bind(admin_product_new_assertThisInitialized(_this));
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    key: "onProductKeyCommand",
    value: function onProductKeyCommand(command) {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
        ...
        className: "col-12 d-flex flex-row justify-content-center align-items-center p-0"
      }, external_react_default.a.createElement(core_["Card"], {
        interactive: false,
        elevation: core_["Elevation"].ONE,
        className: "bp3-dark px-3 py-1 m-0 editor-buttons"
        ...
        className: "col-12 d-flex flex-column editor-description mt-2 p-0"
      }, external_react_default.a.createElement(core_["Card"], {
        interactive: false,
        elevation: core_["Elevation"].ONE,
        className: "bp3-dark px-3 py-1 m-0 editor-buttons px-3 py-1 m-0"
      }, external_react_default.a.createElement(external_draft_js_["Editor"], {
        placeholder: "Ins\xE9rer description.",
