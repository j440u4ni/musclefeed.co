...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    } // { item.sub.length > 0 && this.state.categoriesShow && item.sub.map((subItem) => { return (<Radio className="category-tree-admin-sub" title={<span className="category-tree-admin-sub-name">{subItem.name}</span>} value={subItem.id} />); }) } }
    ...
    value: function render() {
      ...
      }, "Cat\xE9gories"), external_react_default.a.createElement(core_["RadioGroup"], {
        onChange: this.onSelectCategory,
        style: {
          color: '#ffffff'
        },
        className: "mt-0 category-tree",
      ...
      }) : this.state.categories && this.state.categoriesShow && Array.isArray(this.state.categories) && this.state.categories.filter(function (item) {
        return item.parent === 0;
      }).map(function (item) {
        return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(core_["Radio"], {
          className: "category-tree-admin-main",
          label: external_react_default.a.createElement("span", {
            className: "category-tree-admin-main-name"
          }, item.name),
          value: item.id,
          key: item.id
        }), item.sub.length > 0 && _this2.state.categoriesShow && item.sub.map(function (subItem) {
          return external_react_default.a.createElement(core_["Radio"], {
            className: "category-tree-admin-sub ml-2",
            title: external_react_default.a.createElement("span", {
              className: "category-tree-admin-sub-name"
            }, subItem.name),
            value: subItem.id,
            key: subItem.id
          });
