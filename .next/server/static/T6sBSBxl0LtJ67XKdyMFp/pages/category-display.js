...
module.exports = __webpack_require__("r1Dk");
...
/* harmony import */ var _blueprintjs_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("ozu2");
...
/* harmony import */ var _source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("sCFN");
/* harmony import */ var _source_components_component_header_guest__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("6dKc");
/* harmony import */ var _source_components_component_navbar_guest__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("QI5m");
...
var SCategoryDisplay =
/*#__PURE__*/
function (_Component) {
  _inherits(SCategoryDisplay, _Component);

  function SCategoryDisplay(props) {
    var _this;

    _classCallCheck(this, SCategoryDisplay);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SCategoryDisplay).call(this, props));
    _this.state = {
      categories: null,
      logged: false,
      category: null,
  ...
  _createClass(SCategoryDisplay, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      var dispatch = this.props.dispatch;
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_7__[/* fetchAllProductCategories */ "g"])());
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_7__[/* fetchAllProducts */ "j"])());
      ...
      if (this.props.query && this.props.query.hasOwnProperty('sub')) {
        this.setState({
          sub: this.props.query.sub
        });
      }
      ...
      if (this.props.categories && typeof this.props.categories === "string" && this.props.categories.length > 2) {
        var category = JSON.parse(this.props.categories).filter(function (item) {
          return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_3__[/* slugify */ "a"])(item.name) === _this2.props.query.category;
        });
        this.setState({
          specified: category
        });

        if (this.props.query.hasOwnProperty('sub')) {
          var sub = JSON.parse(this.props.categories).filter(function (item) {
            return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_3__[/* slugify */ "a"])(item.name) === _this2.props.query.sub;
          });
          /* sub[0].name = category[0].name + ' ' + sub[0].name; */
    ...
    value: function componentDidUpdate(previous) {
      ...
      if (previous.query !== this.props.query && this.props.query.hasOwnProperty('sub')) {
        this.setState({
          sub: this.props.query.sub
        });
      }
      ...
      if (previous.categories !== this.props.categories && typeof this.props.categories === "string" && this.props.categories.length > 2) {
        var category = JSON.parse(this.props.categories).filter(function (item) {
          return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_3__[/* slugify */ "a"])(item.name) === _this3.props.query.category;
        });
        this.setState({
          specified: category
        });
        ...
        if (this.props.query.hasOwnProperty('sub')) {
          var sub = JSON.parse(this.props.categories).filter(function (item) {
            return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_3__[/* slugify */ "a"])(item.name) === _this3.props.query.sub;
          });
          /* sub[0].name = category[0].name + ' ' + sub[0].name; */
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_header_guest__WEBPACK_IMPORTED_MODULE_4__[/* GuestHeader */ "a"], {
        title: this.state.specified.length > 0 && _typeof(this.state.specified) === "object" && this.state.specified !== [] ? "Muscle Feed | Catégorie " + this.state.specified[0].name : "Muscle Feed | Toutes marques de protéines pour la Musculation & nutrition sportive.",
      ...
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_navbar_guest__WEBPACK_IMPORTED_MODULE_5__[/* GuestNavbar */ "a"], {
        className: "application-guest-navbar"
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "container-top-three d-flex flex-column justify-content-center align-items-start"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", {
        className: "product-category-title"
      }, _typeof(this.state.specified) === "object" && this.state.specified.length > 0 && this.state.specified[0].name), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "row d-flex flex-row justify-content-center"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-3 d-flex flex-column"
      }, " ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_2__["Card"], {
        interactive: false,
        elevation: _blueprintjs_core__WEBPACK_IMPORTED_MODULE_2__["Elevation"].ONE,
        className: "mt-1"
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-9"
      }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_footer_guest__WEBPACK_IMPORTED_MODULE_6__[/* GuestFooter */ "a"], null)));
    }
  }], [{
    key: "getInitialProps",
...
var connectReduxCategoryDisplay = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(SCategoryDisplay);
/* harmony default export */ __webpack_exports__["default"] = (connectReduxCategoryDisplay);
