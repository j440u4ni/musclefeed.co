...
function (_Component) {
  ...
  _createClass(GuestNavbar, [{
    ...
    value: function render() {
      ...
      }, external_react_default.a.createElement("span", null, this.state.user && Array.isArray(this.state.user) && this.state.user.firstname + ' ' + this.state.user.lastname))), external_react_default.a.createElement(link_default.a, {
        href: "/user-cart"
