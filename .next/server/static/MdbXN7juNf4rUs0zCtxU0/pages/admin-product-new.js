...
var addProductQuery = "mutation addProductQuery($title: String!, $quantity: Int!, $provider: String!, $description_title: String!, $description: String!, $image: String!) { \n    addProductQuery(title: $title, quantity: $quantity, provider: $provider, description_title: $description_title, description: $description, image: $image) { id, title, quantity, provider, description_title, description, image } }";
...
var fetchProductsQuery = "query { fetchAllProducts { id, title, quantity, provider, description_title, description, image } } ";
...
function addProductService(title, quantity, provider, description_title, description, image) {
  ...
  (function (dispatch) {
    fetchAllProductsService().then(function (response) {
      ...
      if (second.hasOwnProperty('errors')) {
        ...
        external_js_cookie_default.a.set('products', JSON.stringify(second.data.fetchAllProducts));
        dispatch(success(JSON.stringify(second.data.fetchAllProducts)));
      }
    });
  });
...
function addProduct(title, quantity, provider, description_title, description, image) {
  return function (dispatch) {
    addProductService(title, quantity, provider, description_title, description, image).then(function (response) {
      dispatch(request());
      return response;
    }).then(function (second) {
