...
function (_Component) {
  ...
  _createClass(SCategoryDisplay, [{
    ...
    value: function render() {
      ...
      this.state.products && console.log(this.state.products.filter(function (i) {
        return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_2__[/* slugify */ "a"])(i.name) === _this2.state.sub;
      }));
