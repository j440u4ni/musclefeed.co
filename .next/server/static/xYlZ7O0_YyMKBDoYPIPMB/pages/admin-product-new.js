...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function render() {
      ...
      }, "Cat\xE9gories"), external_react_default.a.createElement(RadioGroup, null, this.state.categories && typeof this.state.categories === "string" && this.state.categories.length <= 2 ? external_react_default.a.createElement(external_antd_["Empty"], {
