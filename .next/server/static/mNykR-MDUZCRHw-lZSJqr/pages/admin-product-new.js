...
function (_Component) {
  ...
  component_add_category_createClass(SAddProductCategory, [{
    ...
    value: function render() {
      ...
      }).push(external_react_default.a.createElement(external_antd_["Select"].Option, {
        value: 0,
        className: "category-select-input"
      }, external_react_default.a.createElement("span", {
        className: "cart-select-option"
      }, "Aucun Parent"))) : external_react_default.a.createElement(external_antd_["Select"].Option, {
        value: 0,
