  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function onProductDescription(editorState) {
      this.setState({
        ...
        productDescription: JSON.stringify(Object(external_draft_js_["convertToRaw"])(editorState.getCurrentContent()))
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
      ...
      }, this.state.uploaded === false ? external_react_default.a.createElement(external_antd_["Icon"], {
        ...
        }, "Choisir une Cat\xE9gorie")
      }, this.state.categories && Array.isArray(this.state.categories) && this.state.categories.filter(function (i) {
        return i.parent === 0;
      }).map(function (item) {
        return external_react_default.a.createElement(external_antd_["Select"].OptGroup, {
          label: external_react_default.a.createElement("span", {
            className: "category-tree-admin-main-name"
          }, item.name),
          key: item.id
        }, item.sub.length > 0 && item.sub.map(function (sub) {
          return external_react_default.a.createElement(external_antd_["Select"].Option, {
            value: sub.id,
            key: sub.id
          }, external_react_default.a.createElement("span", {
