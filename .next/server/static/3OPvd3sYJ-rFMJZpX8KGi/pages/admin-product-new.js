...
var CheckboxGroup = core_["Checkbox"].Group;
...
function (_Component) {
  ...
  function SAdminProductNew(props) {
    ...
    _this.onUpload = _this.onUpload.bind(admin_product_new_assertThisInitialized(_this));
    _this.onConfirmUpload = _this.onConfirmUpload.bind(admin_product_new_assertThisInitialized(_this));
    return _this;
  }
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function onUpload(file) {
      ...
      if (isImage === false) {
        external_antd_["message"].error('Choisir juste des images PNG ou JPEG.');
      }
    ...
    key: "onConfirmUpload",
    value: function onConfirmUpload(information) {
      var _this2 = this;

      if (information.file.status === "uploading") {
        this.setState({
          uploading: true
        });
        return;
      ...
      if (information.file.status === "done") {
        ...
        reader.readAsDataURL(information.file.originFileobj);
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
        ...
        return external_react_default.a.createElement(core_["Checkbox"], {
          key: item.id,
          className: "checkbox-title",
          onChange: _this3.onSelectPerfume,
          id: item.id
        }, item.name);
      })), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        ...
        return external_react_default.a.createElement("div", {
          ...
          onChange: _this3.onSelectWeight,
          id: item.id,
          className: "checkbox-title"
        ...
        onChange: this.onConfirmUpload,
        action: "http://10.188.109.85:3000/upload-product-image"
      }, this.state.productImage.length > 0 ? external_react_default.a.createElement("img", {
        src: this.state.productImage
      }) : external_react_default.a.createElement("div", {
        className: ""
      }, external_react_default.a.createElement(external_antd_["Icon"], {
        type: this.state.uploading ? 'loading' : 'plus'
      }), external_react_default.a.createElement("div", {
        className: "ant-upload-text"
      }, "Choisir Image")))), external_react_default.a.createElement("div", {
        className: "col-5"
      }, external_react_default.a.createElement(core_["InputGroup"], {
