  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
        ...
        className: "bp3-dark p-1"
      }, external_react_default.a.createElement("h5", {
        className: "box-title-white"
      }, "Cat\xE9gories"), this.state.categories && typeof this.state.categories !== "string" && external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        className: "box-notfound-error mt-2"
      })), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
        className: "mt-2 bp3-dark p-1"
      }, external_react_default.a.createElement("h5", {
        className: "box-title-white"
      }, "Parfums"), this.state.categories && typeof this.state.categories !== "string" && external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        className: "box-notfound-error mt-2"
      })), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        ...
        className: "box-title-white"
      }, "Poids & Quantit\xE9s."), this.state.categories && typeof this.state.categories !== "string" && external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        className: "box-notfound-error mt-2"
      }))), external_react_default.a.createElement("div", {
        className: "col-10"
