    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("div", {
        ...
        return external_react_default.a.createElement(link_default.a, {
          ...
          href: "/products?title=".concat(url)
        }, ">", external_react_default.a.createElement(external_antd_["Button"], {
          key: item.id,
...
function (_Component) {
  ...
  function SHome(props) {
    ...
    _this = pages_possibleConstructorReturn(this, pages_getPrototypeOf(SHome).call(this, props));
    _this.state = {
      slideshow: null,
      products: null
    };
  ...
  pages_createClass(SHome, [{
    ...
    value: function componentDidMount() {
      var dispatch = this.props.dispatch;
      dispatch(Object(product_action["j" /* fetchAllProducts */])());
      dispatch(Object(product_action["k" /* fetchAllSlideshowImages */])());
