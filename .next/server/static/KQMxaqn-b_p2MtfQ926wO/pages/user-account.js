...
function (_Component) {
  ...
  _createClass(SUserAccount, [{
    ...
    value: function onLogin(event) {
      ...
      var dispatch = this.props.dispatch;
      dispatch(Object(_source_components_redux_actions_authentication_action__WEBPACK_IMPORTED_MODULE_10__[/* authenticate */ "a"])(this.state.email, this.state.password, false, this.onCancelLogin, next_router__WEBPACK_IMPORTED_MODULE_3___default.a));
    }
  }, {
    key: "render",
    value: function render() {
