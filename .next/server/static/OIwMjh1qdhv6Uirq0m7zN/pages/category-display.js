...
// CONCATENATED MODULE: ./source/musclefeed-configuration.js

var saltSync = external_bcryptjs_default.a.genSaltSync(10, function (error, salt) {
  return salt;
});
...
function (_Component) {
  ...
  _createClass(GuestNavbar, [{
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("div", {
      ...
      }, external_react_default.a.createElement(external_antd_["Button"].Group, null, external_react_default.a.createElement(link_default.a, {
        href: this.state.logged ? "/user-dashboard" : "/user-account"
      }, this.state.logged === false ? external_react_default.a.createElement(external_antd_["Button"], {
        type: "default",
        className: "application-button-default-style"
      }, external_react_default.a.createElement("span", null, external_react_default.a.createElement(external_antd_["Icon"], {
        type: "user",
      ...
      }, external_react_default.a.createElement("span", null, this.state.user && this.state.user.firstname + ' ' + this.state.user.lastname))), external_react_default.a.createElement(link_default.a, {
        href: "/user-cart"
      ...
      }, "Acceuil\xA0", external_react_default.a.createElement("span", {
        ...
        if (item.parent === 0) {
          var url = slugify(item.name);
          var menu = external_react_default.a.createElement(external_antd_["Menu"], null, item.sub.length > 0 && item.sub.map(function (subs) {
            var sub = slugify(subs.name);
          ...
          return external_react_default.a.createElement(link_default.a, {
            ...
            className: "d-flex flex-column p-0"
          }, item.name, "\xA0", external_react_default.a.createElement("span", {
            className: "divider-categories"
          })))));
        }
      }))));
...
/* harmony import */ var _source_components_component_header_guest__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("6dKc");
/* harmony import */ var _source_components_component_navbar_guest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("QI5m");
/* harmony import */ var _source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("jGtb");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  _createClass(SCategoryDisplay, [{
    ...
    value: function componentDidMount() {
      var dispatch = this.props.dispatch;
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_4__[/* fetchAllProductCategories */ "g"])());
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_4__[/* fetchAllProducts */ "j"])());
    ...
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_header_guest__WEBPACK_IMPORTED_MODULE_2__[/* GuestHeader */ "a"], {
        ...
        className: "container-top-three d-flex flex-row justify-content-center"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
