...
var fetchProductsQuery = "query { fetchAllProducts { id, title, quantity, provider, description_title, description, image, details } } ";
...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function onConfirmProduct() {
      ...
      console.log(details); //dispatch(addProduct(this.state.productTitle, this.state.productQuantity, this.state.productProvider, this.state.productDescriptionTitle, this.state.productDescription, this.state.productImage, details));
    }
  }, {
    key: "render",
    value: function render() {
