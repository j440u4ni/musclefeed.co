...
function (_Component) {
  ...
  function SAdminProducts(props) {
    ...
    _this.onSlideshowDelete = _this.onSlideshowDelete.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(SAdminProducts, [{
    ...
    value: function componentDidMount() {
      ...
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_11__[/* fetchAllProducts */ "j"])());
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_11__[/* fetchAllSlideshowImages */ "k"])());
    ...
    key: "onSlideshowDelete",
    value: function onSlideshowDelete(event, id) {
      var dispatch = this.props.dispatch;
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_11__[/* deleteSlideshowImage */ "f"])(id));
    }
  }, {
    key: "onSlideshow",
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_header_guest__WEBPACK_IMPORTED_MODULE_7__[/* GuestHeader */ "a"], {
        ...
        interactive: true,
        className: "bp3-dark p-2 mt-1 mb-1 d-flex flex-row justify-content-center align-items-center slideshow-image-show",
        elevation: _blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__["Elevation"].ONE
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", _defineProperty({
          className: "col-4 p-1",
          key: item.id
        }, "className", "image-list-box-container p-1 ml-1"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
          src: item.image,
          ...
          onClick: function onClick(event) {
            ...
            _this2.onSlideshowDelete(event, item.id);
          }
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_3__["Icon"], {
          icon: "trash",
          className: "trash-icon-slideshow",
          iconSize: 12
        })));
      }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-10"
