...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function render() {
      ...
      /* Array.isArray(this.state.categories) ? this.state.categories.map((item) => { console.log(item); }) : <span>{this.state.categories && this.state.categories.name}</span> */
      ...
      /* Array.isArray(this.state.perfumes) ? this.state.perfumes.map((item) => { console.log(item); }) : <span>{this.state.perfumes && this.state.perfumes.name}</span> */
      this.state.perfumes.map(function (item) {
        console.log(item);
      })), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
      ...
      /* Array.isArray(this.state.weights) ? this.state.weights.map((item) => { console.log(item); }) : <span>{this.state.weights && this.state.weights.name}</span>*/
      this.state.weights.map(function (item) {
        console.log(item);
      }))), external_react_default.a.createElement("div", {
        className: "col-10"
      }, external_react_default.a.createElement(core_["Card"], {
