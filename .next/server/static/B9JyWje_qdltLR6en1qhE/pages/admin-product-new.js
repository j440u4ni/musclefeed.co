  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
        ...
        className: "d-flex flex-row justify-content-center row-product-specifities rows-two mt-1"
      }, external_react_default.a.createElement("div", {
        className: "row rows-two-container"
      }, external_react_default.a.createElement("div", {
        className: "col-4"
      }), external_react_default.a.createElement("div", {
        className: "col-8"
      }))))), this.state.categoryVisible && external_react_default.a.createElement(connectReduxAddCategory, null), this.state.weightVisible && external_react_default.a.createElement(connectReduxAddWeight, null), this.state.perfumeVisible && external_react_default.a.createElement(connectReduxAddPerfume, null)));
    }
  }]);
