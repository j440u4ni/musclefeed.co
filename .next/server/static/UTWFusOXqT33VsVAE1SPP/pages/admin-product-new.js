...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
      ...
      }, "Cat\xE9gories"), this.state.categories && typeof this.state.categories === "string" && this.state.categories.length <= 2 ? external_react_default.a.createElement(external_antd_["Empty"], {
        ...
        return external_react_default.a.createElement("span", null, item.name);
      }) : external_react_default.a.createElement("span", null, this.state.categories && this.state.categories.name)), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
        ...
        return external_react_default.a.createElement("span", null, item.name);
      }) : external_react_default.a.createElement("span", null, this.state.perfumes && this.state.perfumes.name)), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
        className: "mt-2 bp3-dark p-2"
      }, external_react_default.a.createElement("h5", {
        className: "box-title-white"
      }, "Poids & Quantit\xE9s."), this.state.weights && typeof this.state.weights === "string" && this.state.weights.length <= 2 ? external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        description: external_react_default.a.createElement("span", {
          className: "box-notfound-description"
        }, "Aucune poids"),
        ...
        return external_react_default.a.createElement("span", null, item.name);
      }) : external_react_default.a.createElement("span", null, this.state.weights && this.state.weights.name))), external_react_default.a.createElement("div", {
        className: "col-10"
      }, external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
