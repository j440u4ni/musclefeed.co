...
module.exports = { makeProductModel(connection) {
        const Product = connection.define('product', {
            ...
            description: { type: Sequelize.TEXT, allowNull: false, required: true }, details: { type: Sequelize.TEXT, allowNull: false }, provider: { type: Sequelize.STRING, allowNull: false, required: true },
