...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
      ...
      }, "Cat\xE9gories"), this.state.categories && (typeof this.state.categories !== "string" || typeof this.state.categories === "string" && this.state.categories.length === 0) && external_react_default.a.createElement(external_antd_["Empty"], {
        ...
        className: "box-title-white"
      }, "Parfums"), this.state.perfumes && (typeof this.state.perfumes !== "string" || typeof this.state.perfumes === "string" && this.state.perfumes.length === 0) && external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        className: "box-notfound-error mt-2"
      })), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        ...
        className: "box-title-white"
      }, "Poids & Quantit\xE9s."), this.state.weights && (typeof this.state.weights !== "string" || typeof this.state.weights === "string" && this.state.weights.length === 0) && external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        className: "box-notfound-error mt-2"
      }))), external_react_default.a.createElement("div", {
        className: "col-10"
