...
function (_Component) {
  ...
  function SAdminProductNew(props) {
    ...
    _this.onProductStrikeThrough = _this.onProductStrikeThrough.bind(admin_product_new_assertThisInitialized(_this));
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    key: "onProductStrikeThrough",
    value: function onProductStrikeThrough() {
    ...
    value: function render() {
      ...
      }, "Code"))), this.state.editorShow ? external_react_default.a.createElement(external_draft_js_["Editor"], {
