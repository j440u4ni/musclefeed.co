...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function render() {
      ...
      }), this.state.perfumeVisible && external_react_default.a.createElement(connectReduxAddWeight, {
        onClose: this.onClosePerfume
      }), this.state.weightVisible && external_react_default.a.createElement(connectReduxAddPerfume, {
...
function admin_product_new_mapStateToProps(state) {
  var _state$authentication = state.authenticationReducer,
      ...
      weights = _state$authentication.weights,
      perfumes = _state$authentication.perfumes,
      categories = _state$authentication.categories;
  return {
    user: user,
    logged: logged,
    weights: weights,
