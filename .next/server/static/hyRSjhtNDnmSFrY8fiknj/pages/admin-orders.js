...
module.exports = __webpack_require__("iyB6");
...
/*#__PURE__*/
function (_Component) {
  _inherits(SAdminOrders, _Component);

  function SAdminOrders(props) {
    var _this;

    _classCallCheck(this, SAdminOrders);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SAdminOrders).call(this, props));
    _this.state = {
      user: null
    };
    return _this;
...
var connectReduxAdminOrders = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(SAdminOrders);
/* harmony default export */ __webpack_exports__["default"] = (connectReduxAdminOrders);
