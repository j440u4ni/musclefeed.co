...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    key: "render",
    value: function render() {
      //this.props.weights && console.log(this.props.weights.substr(1).slice(0, -1));
      ...
      }, "Cat\xE9gories")), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
        className: "mt-2 bp3-dark p-1"
      }, external_react_default.a.createElement("h5", {
        className: "box-title-white"
      }, "Parfums")), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
        className: "mt-2 bp3-dark p-1"
      }, external_react_default.a.createElement("h5", {
