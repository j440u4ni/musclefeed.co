  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.weights && typeof this.props.weights === "string") {
        this.setState({
          weights: this.props.weights.substr(1).slice(0, -1)
        });
      }

      if (this.props.perfumes && typeof this.props.perfumes === "string") {
        this.setState({
          perfumes: this.props.perfumes.substr(1).slice(0, -1)
        });
      }

      if (this.props.categories && typeof this.props.categories === "string") {
        this.setState({
          categories: this.props.categories.substr(1).slice(0, -1)
        });
      }
    }
  }, {
    ...
    key: "render",
    value: function render() {
      this.state.categories && typeof this.state.categories === "string" && console.log(this.state.categories.length);
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
      ...
      }, "Cat\xE9gories"), this.state.categories && typeof this.state.categories === "string" && this.state.categories.length === 0 ? external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        className: "box-notfound-error mt-2"
      }) : external_react_default.a.createElement("span", null, "0")), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
        className: "mt-2 bp3-dark p-2"
      }, external_react_default.a.createElement("h5", {
        className: "box-title-white"
      }, "Parfums"), this.state.perfumes && typeof this.state.perfumes === "string" && this.state.perfumes.length === 0 ? external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        className: "box-notfound-error mt-2"
      }) : external_react_default.a.createElement("span", null, "0")), external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        ...
        className: "box-title-white"
      }, "Poids & Quantit\xE9s."), this.state.weights && typeof this.state.weights === "string" && this.state.weights.length === 0 ? external_react_default.a.createElement(external_antd_["Empty"], {
        image: external_antd_["Empty"].PRESENTED_IMAGE_SIMPLE,
        className: "box-notfound-error mt-2"
      }) : external_react_default.a.createElement("span", null, "0"))), external_react_default.a.createElement("div", {
        className: "col-10"
      }, external_react_default.a.createElement(core_["Card"], {
        interactive: true,
        elevation: core_["Elevation"].TWO,
