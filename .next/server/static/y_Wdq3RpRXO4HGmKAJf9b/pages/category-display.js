...
/* harmony import */ var _source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("sCFN");
/* harmony import */ var _source_components_component_header_guest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("6dKc");
/* harmony import */ var _source_components_component_navbar_guest__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("QI5m");
/* harmony import */ var _source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("jGtb");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  _createClass(SCategoryDisplay, [{
    ...
    value: function componentDidMount() {
      ...
      var dispatch = this.props.dispatch;
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_5__[/* fetchAllProductCategories */ "g"])());
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_5__[/* fetchAllProducts */ "j"])());
      ...
      if (this.props.categories && typeof this.props.categories === "string" && this.props.categories.length > 2) {
        var category = JSON.parse(this.props.categories).filter(function (item) {
          return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_2__[/* slugify */ "a"])(item.name) === _this2.props.query.category;
        });
        this.setState({
          specified: category
        });
        ...
        if (this.props.query.hasOwnProperty('sub')) {
          var sub = JSON.parse(this.props.categories).filter(function (item) {
            return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_2__[/* slugify */ "a"])(item.name) === _this2.props.query.sub;
          });
    ...
    value: function componentDidUpdate(previous) {
      ...
      if (previous.categories !== this.props.categories && typeof this.props.categories === "string" && this.props.categories.length > 2) {
        var category = JSON.parse(this.props.categories).filter(function (item) {
          return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_2__[/* slugify */ "a"])(item.name) === _this3.props.query.category;
        });
        this.setState({
          specified: category
        });
        ...
        if (this.props.query.hasOwnProperty('sub')) {
          var sub = JSON.parse(this.props.categories).filter(function (item) {
            return Object(_source_musclefeed_configuration__WEBPACK_IMPORTED_MODULE_2__[/* slugify */ "a"])(item.name) === _this3.props.query.sub;
          });
          /* sub[0].name = category[0].name + ' ' + sub[0].name; */
    ...
    value: function render() {
      ...
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_navbar_guest__WEBPACK_IMPORTED_MODULE_4__[/* GuestNavbar */ "a"], {
