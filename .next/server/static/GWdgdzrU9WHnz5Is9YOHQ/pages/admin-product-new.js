...
function product_helper_addProductWeightService(name, value) {
  return fetch(hostname + ':3000/v1/graphql-second-instance/0lqY5JycFu4BwCDv7vsM', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    ...
    body: JSON.stringify({
      query: /* Cannot get final name for export "addProductWeightQuery" in "./source/components/apollo-client/account-apollo/product-query.js" (known exports: addProductCategoryQuery addProductPerfumeQuery, known reexports: ) */ undefined,
      variables: {
        name: name,
        value: value
      }
  ...
  return function (dispatch) {
    addProductPerfumeService(name, description).then(function (response) {
      ...
      if (second.hasOwnProperty('errors')) {
        ...
        external_js_cookie_default.a.set('product-perfumes', JSON.stringify(second.data.addProductPerfumeQuery));
        close(false);
...
function addProductWeight(name, value, close) {
  return function (dispatch) {
    addProductWeightService(name, description).then(function (response) {
      return response;
    }).then(function (second) {
      if (second.hasOwnProperty('errors')) {
        close(false);
        ...
        external_js_cookie_default.a.set('product-weights', JSON.stringify(second.data.addProductWeightQuery));
        close(false);
...
function (_Component) {
  ...
  function SAddProductWeight(props) {
    ...
    _this.onDescription = _this.onDescription.bind(component_add_weight_assertThisInitialized(_this));
