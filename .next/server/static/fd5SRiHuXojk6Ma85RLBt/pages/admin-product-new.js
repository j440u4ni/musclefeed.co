  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.categories && typeof this.props.categories === "string") {
        this.setState({
          categories: this.props.categorie.substr(1).slice(0, -1)
        });
      }
    }
  }, {
    ...
    key: "render",
    value: function render() {
      this.state.categories && console.log(admin_product_new_typeof(this.state.categories)) && console.log(this.state.categories.length);
