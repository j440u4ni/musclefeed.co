...
function authenticateService(email, password, admin) {
  ...
  return fetch(hostname + ':3000/v1/graphql-first-instance/BtL7NQwOt0R7psYw1Fyx', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json'
...
function addProductCategory(name, description, close) {
  return function (dispatch) {
    Object(product_helper["a" /* addProductCategoryService */])(name, description).then(function (response) {
      dispatch(request());
      return response;
    }).then(function (second) {
      if (second.hasOwnProperty('errors')) {
...
function addProductPerfume(name, description, close) {
  return function (dispatch) {
    Object(product_helper["b" /* addProductPerfumeService */])(name, description).then(function (response) {
      dispatch(request());
      return response;
    }).then(function (second) {
      if (second.hasOwnProperty('errors')) {
...
function addProductWeight(name, value, close) {
  return function (dispatch) {
    Object(product_helper["c" /* addProductWeightService */])(name, value).then(function (response) {
      dispatch(request());
      return response;
    }).then(function (second) {
      if (second.hasOwnProperty('errors')) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.weights && typeof this.props.weights === "string") {
        this.setState({
          weights: JSON.parse(this.props.weights)
        });
      }

      if (this.props.perfumes && typeof this.props.perfumes === "string") {
        this.setState({
          perfumes: JSON.parse(this.props.perfumes)
        });
      }
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
        ...
        elevation: core_["Elevation"].TWO,
        className: " bp3-dark"
      }))))), this.state.categoryVisible && external_react_default.a.createElement(connectReduxAddCategory, {
