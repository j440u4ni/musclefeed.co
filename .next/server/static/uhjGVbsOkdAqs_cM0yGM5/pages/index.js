...
/* harmony import */ var _static_resources_main_application_scss__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("yObJ");
/* harmony import */ var _static_resources_main_application_scss__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_static_resources_main_application_scss__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("jGtb");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  _createClass(SHome, [{
    ...
    value: function componentDidMount() {
      ...
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_10__[/* fetchAllProducts */ "j"])());
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_10__[/* fetchAllSlideshowImages */ "k"])());
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_10__[/* fetchAllProductPerfumes */ "h"])());
      dispatch(Object(_source_components_redux_actions_product_action__WEBPACK_IMPORTED_MODULE_10__[/* fetchAllProductWeights */ "i"])());
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_header_guest__WEBPACK_IMPORTED_MODULE_1__[/* GuestHeader */ "a"], {
        ...
        className: "container-fluid px-2 elevation-products px-5"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_6__["Card"], {
        interactive: false,
        elevation: _blueprintjs_core__WEBPACK_IMPORTED_MODULE_6__["Elevation"].ONE,
        className: "elevation-products-list d-flex flex-row justify-content-center"
      }, this.state.products && Array.isArray(this.state.products) && this.state.products.slice(0, 4).map(function (item) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: item.id,
        ...
        }, item.description_title), _this2.state.description && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          className: "product-description-text-home"
        }, Object(draft_js__WEBPACK_IMPORTED_MODULE_7__["convertFromRaw"])(JSON.parse(item.description)).getPlainText().substr(0, 110)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "d-flex flex-row p-0 justify-content-end"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "col-3"
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "col-3"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Button"], {
          type: "default",
          text: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Icon"], {
            type: "shopping-cart",
            className: "button-home-buy"
          })
        })))));
      }))))));
    }
