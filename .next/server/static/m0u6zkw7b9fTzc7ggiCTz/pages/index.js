...
function (_Component) {
  ...
  _createClass(SHome, [{
    ...
    value: function minimum(item) {
      return JSON.parse(item.details).weights.reduce(function (result, object) {
        return object.price < result.price ? object : result;
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_header_guest__WEBPACK_IMPORTED_MODULE_1__[/* GuestHeader */ "a"], {
        ...
        className: "container-top-three d-flex"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "elevation-products-list d-flex flex-wrap justify-content-center mt-2"
      }, this.state.products && Array.isArray(this.state.products) && this.state.products.slice(0, 5).map(function (item) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: item.id,
          ...
          className: _this2.props.logged === false ? "col-6" : "col-8"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          className: "product-price-home mr-auto"
        }, _this2.minimum(item).price, "\xA0", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_6__["Icon"], {
          icon: "euro",
          color: "#001526",
          iconSize: 18
        }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _this2.props.logged === false ? "col-6" : "col-4"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_6__["ButtonGroup"], null, _this2.props.logged && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_6__["Button"], {
          intent: "danger",
          icon: "heart"
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_6__["Button"], {
          intent: "primary",
          icon: "shopping-cart",
          text: _this2.props.logged === false && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
            className: "button-product-user"
          }, "Commander")
        }))))));
      })))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_source_components_component_footer_guest__WEBPACK_IMPORTED_MODULE_2__[/* GuestFooter */ "a"], {
        className: "footer-guest-home-guest"
      })));
    }
  }]);
