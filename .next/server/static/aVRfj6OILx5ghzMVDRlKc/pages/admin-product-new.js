...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return showWarning; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("cDcd");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("Exp3");
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(antd__WEBPACK_IMPORTED_MODULE_1__);
...
function (_Component) {
  ...
  function SAddProductPerfume(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SAddProductPerfume).call(this, props));
  }

  _createClass(SAddProductPerfume, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_antd_["Drawer"], null));
    }
  }]);
...
function (_Component) {
  ...
  function SAddProductWeight(props) {
    ...
    return component_add_weight_possibleConstructorReturn(this, component_add_weight_getPrototypeOf(SAddProductWeight).call(this, props));
  }
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["mutation addProductCategoryQuery($name: String!, $description: String)! { addProductCategoryQuery(name: $name, description: $description) { id, name, description } }"]);
...
var addProductCategoryQuery = external_graphql_tag_default()(_templateObject());
...
function addProductCategory(name, description) {
  return function (dispatch) {
    addProductCategoryService(name, description).then(function (response) {
      return response;
    }).then(function (second) {
      if (second.hasOwnProperty('errors')) {
        Object(alert_toasts["a" /* showWarning */])("Addition catégorie échoué.");
      } else {
        ccookie.set('product-categories', JSON.stringify(second.data.addProductCategoryQuery));
...
function (_Component) {
  ...
  component_add_category_createClass(SAddProductCategory, [{
    ...
    value: function onConfirm() {
      ...
      dispatch(addProductCategory(this.state.name, this.state.description));
    }
  }, {
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_antd_["Drawer"], {
        ...
        className: "d-flex flex-row justify-content-space-between m-0 mt-1"
      }, external_react_default.a.createElement("div", {
        className: "col-6"
...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    value: function onPerfume() {
      this.setState({
        perfumeVisible: !this.state.perfumeVisible
      });
    }
  }, {
    key: "onWeight",
    value: function onWeight() {
      this.setState({
        weightVisible: !this.state.weightVisible
      });
    }
  }, {
    key: "onCloseCategory",
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
        ...
        className: "button-text"
      }, "Poids")))))), this.state.categoryVisible && external_react_default.a.createElement(connectReduxAddCategory, null), this.state.weightVisible && external_react_default.a.createElement(connectReduxAddWeight, null), this.state.perfumeVisible && external_react_default.a.createElement(connectReduxAddPerfume, null)));
    }
  }]);
