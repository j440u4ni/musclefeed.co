...
/* harmony default export */ var component_add_perfume = (connectReduxAddPerfume);
...
/* harmony default export */ var component_add_weight = (connectReduxAddWeight);
...
/* harmony default export */ var component_add_category = (connectReduxAddCategory);
...
function (_Component) {
  ...
  admin_product_new_createClass(SAdminProductNew, [{
    ...
    key: "render",
    value: function render() {
      console.log(this.state.categoryVisible);
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(component_header_guest["a" /* GuestHeader */], {
        ...
        className: "button-text"
      }, "Poids")))))), this.state.categoryVisible && external_react_default.a.createElement(/* Cannot get final name for export "SAddProductCategory" in "./source/components/component-add-category.js" (known exports: default, known reexports: ) */ undefined, null), this.state.weightVisible && external_react_default.a.createElement(/* Cannot get final name for export "SAddProductWeight" in "./source/components/component-add-weight.js" (known exports: default, known reexports: ) */ undefined, null), this.state.perfumeVisible && external_react_default.a.createElement(/* Cannot get final name for export "SAddProductPerfume" in "./source/components/component-add-perfume.js" (known exports: default, known reexports: ) */ undefined, null)));
    }
  }]);
