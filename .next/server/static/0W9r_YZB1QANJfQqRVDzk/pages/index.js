...
function (_Component) {
  ...
  _createClass(GuestNavbar, [{
    ...
    value: function render() {
      ...
      }, this.state.logged === false ? external_react_default.a.createElement("span", null, external_react_default.a.createElement(external_antd_["Icon"], {
        type: "user",
        className: "application-button-icon-style",
        style: {
          fontSize: 15
        }
      }), "\xA0Mon compte") : external_react_default.a.createElement("span", {
        className: "application-user-link"
      }, "Jaaouani Oussama"))), external_react_default.a.createElement(link_default.a, {
        href: "/user-cart"
      }, external_react_default.a.createElement(external_antd_["Button"], {
        type: "default",
        className: "application-button-default-style"
