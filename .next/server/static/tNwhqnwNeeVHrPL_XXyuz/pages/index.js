...
function (_Component) {
  ...
  pages_createClass(SHome, [{
    ...
    value: function render() {
      ...
      }, (this.state.slideshow && typeof this.state.slideshow === "string" && this.state.slideshow.length <= 2 || !this.state.slideshow) && external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("div", null, external_react_default.a.createElement("h3", null, "1")), external_react_default.a.createElement("div", null, external_react_default.a.createElement("h3", null, "1")), external_react_default.a.createElement("div", null, external_react_default.a.createElement("h3", null, "1"))), this.state.slideshow && Array.isArray(this.state.slideshow) && this.state.slideshow.map(function (item) {
        console.log(item);
      })))));
    }
  }]);
